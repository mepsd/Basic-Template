    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg" style="font-weight:bold;color:#29338d;">Sign in to start your session
                </p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-block"
                                style="background-color:#29338d;color:white;border-radius:30px;">SIGN IN</button>
                        </div>
                        <div class="col-12" style="text-align:center;padding-top:20px;">
                            <a href="{{ url('/register') }}" style="font-weight:bold;color:#29338d;">New To here? let us be friends</a>
                        </div>
                    </div>
            </div>
            </form>
